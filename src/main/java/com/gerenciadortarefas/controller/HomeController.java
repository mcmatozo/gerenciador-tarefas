...
public class HomeController implements Initializable {
    ...
    private void setTasks() {
        List<Task> tasks = List.of(
                ...
                new Task("Estudar matemática", "Revisar álgebra para a prova de sexta-feira"),
                ...
                new Task("Planejar a semana", "Organizar as tarefas e compromissos da próxima semana"),
                ...
                new Task("Estudar Java", "Praticar programação com Java e estudar padrões de design"),
                new Task("Organizar os papéis", "Separar documentos importantes e reciclar papéis inúteis"),
                new Task("Visitar os avós", "Passar a tarde com os avós e ajudar no que for necessário"),
                new Task("Fazer backup", "Fazer backup dos arquivos importantes no disco externo"),
                new Task("Aprender uma receita nova", "Cozinhar um prato novo para o jantar de sábado"),
                new Task("Limpar o carro", "Lavar e aspirar o carro no final de semana"),
                new Task("Assistir a uma palestra online", "Participar do evento de tecnologia às 19h"),
                new Task("Planejar as férias", "Pesquisar destinos e fazer um orçamento para viajar"));
